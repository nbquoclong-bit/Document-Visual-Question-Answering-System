...
def prepare_and_run_qwen2_5_training():
    ...
    kernel_slug = "qwen2-5-vl-finetune-lora"
    kernel_id = f"lminhsang241/{kernel_slug}"
    
    train_dir = Path("d:/STUDY/MLIoT/project/kaggle_automation/train_kernel_qwen2_5")
    train_dir.mkdir(parents=True, exist_ok=True)

    metadata = {
        "id": kernel_id,
        "title": "qwen2-5-vl-finetune-lora",
        "code_file": "qwen2_5_vl_finetune.ipynb",
        "language": "python",
    ...
    notebook_cells = [
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# 4. Dataset & Target-Only Loss Masking Collator\n",
                ...
                "\n",
                "print(f\"🎯 Khớp thành công {len(train_items)} mẫu huấn luyện có ảnh thật!\")\n",
                "\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "    messages = [{\"role\": \"user\", \"content\": [{\"type\": \"image\", \"image\": img}, {\"type\": \"text\", \"text\": s[\"question\"]}]}]\n",
                ...
                "\n",
                "print(\"\\n\" + \"=\" * 85)\n",
                "print(\"📊 TỔNG HỢP KẾT QUẢ ĐÁNH GIÁ MÔ HÌNH SAU KHI FINE-TUNE:\")\n",
                "print(\"=\" * 85)\n",
    ...
    nb_path = train_dir / "qwen2_5_vl_finetune.ipynb"
...
if __name__ == "__main__":
    prepare_and_run_qwen2_5_training()
